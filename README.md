...
Para iniciar é recomendado estudar ou revisitar quando for necessário as pastas [GCC](GCC) e [Cmake](CMAKE) para um entendimento inicial sobre compilação de arquivos C. Logo depois é válido seguir a ordem proposta na [apostila](https://www-usr.inf.ufsm.br/~juvizzotto/elc1067-2013b/estrut-dados-pucrio.pdf). Há também na pasta de [Ordenação]([GCC](https://github.com/Frankl1sales/Estrutura-de-Dados/tree/main/Ordena%C3%A7%C3%A3o/Visualiza%C3%A7%C3%A3oSort)) uma implementação bonus que em ordenação que serve visualização a ação de alguns desse algoritmos em um conjunto de dados desorganizado inicialmente.
